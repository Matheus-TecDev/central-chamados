...
class Ticket(Base):
    ...
    support_type_id: Mapped[int] = mapped_column(ForeignKey("support_types.id"), nullable=False, index=True)
    ...
    support_area = relationship("SupportArea", back_populates="tickets")
    support_type = relationship("SupportType", back_populates="tickets")
